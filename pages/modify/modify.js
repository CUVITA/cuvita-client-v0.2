    ...
    this.setData({
      ...
      fields: [
        [
          ...
          { tag: 'van-field', name: 'tel', type: 'text', label: localePackage.form.tel.label[locale], placeholder: localePackage.form.tel.placeholder[locale], required: true },
          ...
          { tag: 'van-datetime-picker', name: 'birthday', title: localePackage.form.birthday.label[locale], options: { minDate: new Date(1990, 0, 1).getTime(), maxDate: new Date().getTime() }, required: true, is: 'date' }
        ]
      ]
    });
