...
export const success = {
    ...
    message: [
        "感谢您选择了VITA，我们将竭诚为您带来丰富多彩的会员福利",
        "Thank you for choosing VITA, we sincerely wish you enjoy your membership benefits"
    ],
...
export const fail = {
    modal: {
        ...
        content: [
            "我们未能确认您的交易信息。如果您确认已完成了支付，请联系客服并提供您的交易单号：",
            "We're unable to confirm your transactions, please contact customer services with reference: "
        ]
    },
    toast: {
        unexpected: [
            "注册失败，请联系客服获取详情",
            "Oops! Something went wrong, please contact customer services"
        ],
...
export const form = {
    ...
    birthday: {
        label: ["生日(必填）", "Birthday"],
        placeholder: ["请点击选择生日", ""]
    },
    school: {
        label: ["就读学校(必填）", "School"],
